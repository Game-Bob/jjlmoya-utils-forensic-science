...
export const content: TimeOfDeathAlgorMortisLocaleContent = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'A troca de calor depende diretamente do peso corporal do individuo, da conveccao do ar ambiente e das camadas de roupa protetoras presentes no cadaver.' + " Uma estimativa cuidadosa também considera o ambiente, a roupa, a posição do corpo, o movimento do ar e a fiabilidade de cada medição. Diferenças podem surgir devido à humidade, a fontes de calor, à superfície ou a documentação incompleta. Por isso, o resultado deve ser entendido como um intervalo com incerteza e comparado com outros dados médico-legais, nunca como uma hora exacta isolada." + " A comparação deve considerar a qualidade da imagem, a deformação, as condições de medição e a documentação completa do exame. Uma conclusão confiável exige características independentes, relações espaciais claras, limitações registradas e revisão por um especialista qualificado." + " A análise médico-legal exige atenção à variação térmica, à humidade, à pressão atmosférica, à exposição solar e à posição do cadáver. Esses fatores alteram a medição e devem ser descritos com precisão, juntamente com a margem de incerteza e a documentação do local." },
