...
export const content: ToolLocaleContent = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "Resultatet är en startpunkt för att kontrollera filens proveniens och bevarandestatus. Beskriv separat vilka signaler som observerades, vilka som saknas och vilken ytterligare information som behövs. Då blir det svårare att misstolka ett heuristiskt poängtal som ett slutligt äkthetsbesked." },
    { type: 'paragraph', html: "En filändelse eller en enskild tagg kan inte bevisa format, redigeringshistorik eller äkthet. Kontrollera den faktiska headerstrukturen, pixeldimensioner, färgprofil, miniatyr och programinformation och jämför med insamlingsloggen. En hash bekräftar filens identitet men inte sanningen i det fotograferade innehållet. Ta hänsyn till omkomprimering och borttagna metadata från delningsplattformar och dokumentera både undersökningens omfattning och kvarvarande osäkerhet. Beskriv vilka fynd som stöder en hypotes, vilka som talar emot den och vilken information som fortfarande saknas." },
    { type: 'paragraph', html: "Att tid eller GPS saknas betyder inte automatiskt att bilden har manipulerats. Kamerainställningar, delningsplattformar, sekretess och omsparning kan ta bort eller skriva om taggar. Jämför därför filhuvud, pixeldimensioner, färgprofil, miniatyr, programtaggar och insamlingslogg. Bevara originalet på ett kontrollerat medium, beräkna hash och dokumentera kopior, konverteringar och analysmiljö. Använd resultatet som grund för fortsatt granskning och jämför med proveniens, vittnesuppgifter, enhetsloggar och validerade metoder." },
    { type: 'paragraph', html: "Dokumentera anskaffningsdatum, lagringsmedium, hash, analysmiljö, kontrollerade fält, observationer och obesvarade frågor separat. Dra inte slutsatsen att en bild har redigerats enbart för att metadata saknas. Jämför fynden med proveniens, insamlingslogg och bevarandestatus så att en annan granskare kan upprepa kontrollen. Skriv även upp varje kopia eller konvertering och skilj en heuristisk signal från ett slutligt expertutlåtande." },
