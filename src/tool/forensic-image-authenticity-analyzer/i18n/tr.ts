...
export const content: ToolLocaleContent = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "Çalışma varsayımını destekleyen, ona karşı çıkan ve henüz eksik olan bulguları ayrı ayrı kaydedin. Bu ayrım teknik ipucu ile nihai uzman görüşü arasındaki sınırı korur." },
    { type: 'paragraph', html: "Sonuç, dosyanın kökenini ve korunma durumunu kontrol etmek için başlangıç noktasıdır. Gözlenen işaretleri, bulunmayan işaretleri ve ihtiyaç duyulan ek bilgileri ayrı ayrı açıklayın. Bu kayıt, buluşsal puanın özgünlük hakkında kesin hüküm gibi yanlış anlaşılmasını önler." },
    { type: 'paragraph', html: "Dosya uzantısı veya tek bir etiket biçimi, düzenleme geçmişini ya da özgünlüğü kanıtlayamaz. Gerçek başlık yapısını, piksel boyutunu, renk profilini, küçük önizlemeyi ve yazılım bilgilerini kontrol ederek edinim kaydıyla karşılaştırın. Özet değeri dosyanın aynı olduğunu doğrular, ancak fotoğraftaki içeriğin gerçekliğini kanıtlamaz. Paylaşım platformlarının yeniden sıkıştırmasını ve meta veri silmesini hesaba katın; incelemenin kapsamını ve kalan belirsizliği kaydedin. Hipotezi destekleyen, ona karşı çıkan ve henüz elde olmayan bulguları ayrı ayrı açıklayın." },
    { type: 'paragraph', html: "Çekim zamanı veya GPS bilgisinin bulunmaması görüntünün değiştirildiğini otomatik olarak göstermez. Kamera ayarları, paylaşım platformları, gizlilik seçenekleri ve yeniden kaydetme işlemleri etiketleri silebilir ya da yeniden yazabilir. Bu nedenle dosya başlığını, piksel boyutunu, renk profilini, küçük önizlemeyi, yazılım etiketlerini ve edinim kaydını birlikte karşılaştırın. Özgün dosyayı kontrollü ortamda saklayın, analizden önce özetini alın ve kopyaları, dönüşümleri, analiz ortamını kaydedin. Sonucu ek inceleme için ipucu sayın; köken, tanık bilgileri, cihaz kayıtları ve doğrulanmış yöntemlerle birlikte değerlendirin." },
    { type: 'paragraph', html: "Kayıtta edinim tarihini, depolama ortamını, özeti, analiz ortamını, incelenen alanları, gözlemleri ve açık soruları ayrı ayrı belirtin. Yalnızca eksik meta veriye bakarak düzenleme sonucu çıkarmayın. Bulguları dosyanın kökeni, edinim günlüğü ve saklama durumu ile karşılaştırın; böylece başka bir incelemeci aynı dosyayı yeniden kontrol edebilir. Kopya ve dönüştürme adımlarını da kaydedin ve buluşsal işareti nihai uzman görüşünden ayırın." },
