...
export const content: ToolLocaleContent = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "Rozszerzenie pliku ani pojedynczy tag nie może potwierdzić formatu, historii edycji lub autentyczności. Sprawdź rzeczywistą strukturę nagłówka, wymiary pikseli, profil kolorów, miniaturę i informacje o oprogramowaniu, a następnie porównaj je z zapisem akwizycji. Hash potwierdza tożsamość pliku, lecz nie prawdziwość przedstawionej treści. Uwzględnij ponowną kompresję i usuwanie metadanych przez platformy udostępniania oraz zapisz zakres badania i pozostałą niepewność." },
    { type: 'paragraph', html: "Brak czasu wykonania lub GPS nie oznacza automatycznie, że obraz został zmanipulowany. Ustawienia aparatu, platformy udostępniania, prywatność i ponowny zapis mogą usuwać albo przepisywać tagi. Porównuj nagłówek pliku, wymiary pikseli, profil kolorów, miniaturę, tagi oprogramowania i zapis akwizycji. Zachowaj oryginał na kontrolowanym nośniku, oblicz hash i dokumentuj kopie, konwersje oraz środowisko analizy. Wynik traktuj jako powód do dalszych badań i zestawiaj go z pochodzeniem, zeznaniami, logami urządzenia oraz zwalidowanymi metodami." },
    { type: 'paragraph', html: "W dokumentacji zapisz osobno datę pozyskania, nośnik, hash, środowisko analizy, sprawdzone pola, obserwacje i nierozstrzygnięte pytania. Nie wnioskuj o edycji wyłącznie na podstawie brakujących metadanych. Porównaj wynik z pochodzeniem pliku, logiem akwizycji i jego stanem zachowania, aby kolejny analityk mógł powtórzyć kontrolę. Zapisz także każdą kopię lub konwersję i oddziel wskazówkę heurystyczną od końcowej opinii eksperta." },
