...
export const content: ToolLocaleContent = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "Отдельно отмечайте, какие признаки подтверждают рабочую гипотезу, какие ей противоречат и какие данные ещё отсутствуют. Это помогает сохранить границу между технической подсказкой и экспертным выводом." },
    { type: 'paragraph', html: "Результат проверки является началом анализа происхождения и сохранности файла. Отдельно описывайте подтверждённые признаки, отсутствие ожидаемых признаков и сведения, которые ещё нужно получить. Такая запись не позволяет принять эвристический балл за окончательный вывод о подлинности." },
    { type: 'paragraph', html: "Расширение файла или один тег не могут доказать формат, историю редактирования или подлинность. Проверяйте фактическую структуру заголовка, размеры пикселей, цветовой профиль, миниатюру и сведения о программе, сопоставляя их с журналом получения. Хеш подтверждает идентичность файла, но не истинность содержания снимка. Учитывайте повторное сжатие и удаление метаданных сервисами обмена, а также фиксируйте границы проверки и оставшуюся неопределённость. Описывайте, какие признаки подтверждают гипотезу, какие ей противоречат и какие сведения ещё требуется получить." },
    { type: 'paragraph', html: "Отсутствие времени съёмки или GPS не означает автоматически, что изображение изменяли. Настройки камеры, сервис обмена, приватность и повторное сохранение могут удалить или переписать теги. Поэтому сопоставляйте заголовок файла, размеры пикселей, цветовой профиль, миниатюру, теги программ и журнал получения. Сохраните оригинал на контролируемом носителе, вычислите хеш и зафиксируйте копии, конвертации и среду анализа. Рассматривайте результат как основание для дальнейшей проверки и сравнивайте его с происхождением, показаниями, журналами устройства и проверенными методами." },
    { type: 'paragraph', html: "В журнале отдельно указывайте дату получения, носитель, хеш, среду анализа, проверенные поля, наблюдения и нерешённые вопросы. Не делайте вывод о редактировании только по отсутствующим метаданным. Сопоставляйте результат с происхождением файла, журналом получения и состоянием хранения, чтобы другой специалист мог повторить проверку. Фиксируйте также каждую копию или конвертацию и отличайте эвристическую подсказку от окончательного экспертного заключения." },
