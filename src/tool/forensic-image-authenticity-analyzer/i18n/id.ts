...
export const content: ToolLocaleContent = {
  ...
  seo: [
    ...
    { type: 'title', text: 'Memeriksa Jejak Perangkat Lunak dan Struktur Berkas', level: 3 },
    { type: 'paragraph', html: 'Tag perangkat lunak seperti editor foto atau layanan ekspor dapat menjelaskan bagaimana berkas terakhir disimpan, tetapi tidak menceritakan seluruh sejarah gambar. Bandingkan tag tersebut dengan ukuran piksel, profil warna, orientasi, thumbnail, dan urutan byte pada header. Ketidaksesuaian adalah alasan untuk melakukan pemeriksaan lanjutan, bukan bukti otomatis bahwa isi gambar telah dimanipulasi. Aplikasi kamera, sistem operasi, dan platform berbagi dapat menulis ulang metadata tanpa mengubah subjek visual.' },
    { type: 'paragraph', html: 'Untuk menjaga nilai pembuktian, simpan berkas sumber dalam media yang terkontrol, hitung hash sebelum analisis, dan catat setiap salinan atau konversi. Pemeriksaan browser ini membantu triase secara lokal, sehingga gambar sensitif tidak perlu diunggah. Namun, hasil tampilan harus dapat diulang dari salinan yang sama dan dibandingkan dengan akuisisi asli, log perangkat, keterangan saksi, serta metode laboratorium yang tervalidasi.' },
    { type: 'paragraph', html: 'Analisis kompresi, pola piksel, dan pemeriksaan visual dapat memberi sinyal tambahan, tetapi masing-masing memiliki asumsi dan tingkat kesalahan. Foto yang dikompresi ulang dapat meniru beberapa ciri pengeditan, sedangkan pengeditan ringan dapat meninggalkan jejak yang sangat kecil. Gunakan beberapa sumber bukti yang independen, jelaskan ketidakpastian, dan hindari mengubah skor heuristik menjadi klaim pasti tentang keaslian atau niat seseorang.' },
    { type: 'paragraph', html: 'Jika sebuah gambar akan dipakai dalam penyelidikan, buat catatan pemeriksaan yang menyebutkan nama berkas, ukuran, hash, perangkat lunak, waktu analisis, dan temuan yang dapat diulang. Jelaskan pula apa yang tidak dapat diperiksa oleh alat ini. Transparansi tentang batasan membantu peninjau lain membedakan petunjuk teknis dari kesimpulan autentikasi.' },
