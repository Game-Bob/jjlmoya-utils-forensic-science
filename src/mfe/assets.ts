...
const UTILITY_ASSET_ROOT = "/_utilities/forensic-science";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/forensic-science/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/forensic-science/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("forensic-science");
